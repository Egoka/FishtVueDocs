...
<template>
  ...
  <Dialog v-model="dialog" position="center" close-button class="p-0">
    <template #default="{closeDialog}">
      <div class="flex items-start justify-between p-4 border-b rounded-t border-gray-200 dark:border-gray-800">
