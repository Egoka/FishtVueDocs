...
| `border`              | `border` or `"border-0 border-b-0 border-t-0 border-r-0"` or `ITableStylesBorder` or `undefined` | Border styles for various parts of the table.                                                   |
...
|-----------------------|-----------------------------------------|---------------------------------------------------------------------------------------------------|
| `sortColumns`         | `UnwrapNestedRefs<Sorted>`             | The current sorting state for all columns.                                                       |
| `filterColumns`       | `UnwrapNestedRefs<Filters>`            | The current filtering state for all columns.                                                     |
| `widthsColumns`       | `UnwrapNestedRefs<Widths>`             | The current widths for all columns.                                                              |
| `queryTable`          | `ReadRef<Search>`                      | The current search query.                                                                        |
| `pageTable`           | `ReadRef<Page>`                        | The current page number.                                                                         |
| `sizeTable`           | `ReadRef<Page>`                        | The current page size.                                                                           |
| `allData`             | `ReadRef<TableProps["dataSource"]>`    | The entire data source of the table.                                                             |
| `isLoading`           | `ReadRef<boolean>`                     | Indicates whether the table is in a loading state.                                               |
| `mode`                | `ReadRef<TableProps["mode"]>`          | The current styling mode of the table.                                                           |
| `isVisibleToolbar`    | `ReadRef<boolean>`                     | Indicates whether the toolbar is visible.                                                        |
| `isSearch`            | `ReadRef<boolean>`                     | Indicates whether search functionality is enabled.                                               |
| `isFilterClear`       | `ReadRef<boolean>`                     | Indicates whether the "clear all filters" button is enabled.                                     |
| `isColumns`           | `ReadRef<boolean>`                     | Indicates whether columns are defined.                                                           |
| `isSummary`           | `ReadRef<boolean>`                     | Indicates whether summary rows are defined.                                                      |
| `countDataOnLoading`  | `ReadRef<TableProps["countDataOnLoading"]>` | The number of rows to simulate during data loading.                                              |
| `classMaskQuery`      | `ReadRef<ITableStyles["maskQuery"]>`   | The mask applied to query text.                                                                  |
| `noData`              | `ReadRef<TableProps["noData"]>`        | The message displayed when there is no data.                                                     |
| `noColumn`            | `ReadRef<TableProps["noData"]>`        | The message displayed when no columns are defined.                                               |
| `noFilter`            | `ReadRef<IFilter["noFilter"]>`         | The message displayed when no filters are applied.                                               |
| `iconSort`            | `ReadRef<ISort["icon"]>`               | The icon used for sorting.                                                                       |
| `resizedColumns`      | `ReadRef<TableProps["resizedColumns"]>`| Indicates whether column resizing is enabled.                                                    |
| `lengthData`          | `ReadRef<number>`                      | The total number of rows in the data source.                                                     |
| `groupField`          | `ReadRef<IGrouping["groupField"]` or `ReadRef<null>` | The field used for grouping data.                                                               |
| `isFilter`            | `ReadRef<boolean>`                     | Indicates whether filtering is enabled.                                                          |
| `isSort`              | `ReadRef<boolean>`                     | Indicates whether sorting is enabled.                                                            |
| `isGroup`             | `ReadRef<boolean>`                     | Indicates whether grouping is enabled.                                                           |
| `isPagination`        | `ReadRef<boolean>`                     | Indicates whether pagination is enabled.                                                         |
